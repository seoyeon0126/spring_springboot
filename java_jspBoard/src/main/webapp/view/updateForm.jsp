...
<body>
   <form action="/updatePro.iot" method="post" name="wForm">
   <table border="1">
      ...
      <tbody> 
	        ...
	        <tr><th style="width: 30%">글쓴이</th>
	       		<td><input name="writer" value='${dto.writer}' class='chk' size="50"></td>
	        </tr>
		    <tr><th style="width: 30%">글내용</th>
		        <td><textarea rows="15" cols="50" class='chk' name="content">${dto.content}</textarea></td>
		    </tr>
		    <tr><th style="width: 30%">이메일</th>
		         <td><input size="50" type="email" class='chk' name="email" value='${dto.email}'></td>
		     </tr>
		     <tr><th style="width: 30%">비밀번호</th>
		         <td><input size="50" type="password" class='chk' name="passwd" value='${dto.passwd}'></td>
		     </tr>
    </tbody>
    <tfoot>
