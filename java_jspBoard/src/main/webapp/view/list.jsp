...
<body>
	<h3>게시글 목록</h3>
	<p style="text-align: right; width: 960px;">전체게시글 수: &nbsp; ${allCount}</p>
	<p style="text-align: left; width: 960px;">
	<input type="button" value="글쓰기" onclick="javascript:location.href='/writeForm.iot'"></input></p>
	<table>
		<thead>
			<tr>
				<th>번호</th>
		...
		<c:choose>
			...
			<c:forEach var="dto" items="${list}">
				<tr>
					...
					<a href="/content.iot?num=${dto.num}&amp;currentPage=${currentPage}">${dto.subject}</a>
		...
		<t:foot>
				<tr>
					<td colspan="6" style="text-align: center">
						<c:forEach var = "i" begin="${1}" end="${pageAllCnt}">
							<a href="/list.iot?currentPage=${i}">[${i}]</a>&nbsp;&nbsp;
						</c:forEach>
					</td>
				</tr>
		</t:foot>
